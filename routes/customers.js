...
exports.readCustomer = function(req, res) {
	console.log("read customer called");//I GET TO HERE AND THIS IS AS FAR AS IT GOES
	
	// get a pg client from the connection pool
	pool.connect(function(err, client, done) { //NOTHING HAPPENS WHEN I GET HERE<------------------
		...
		if(req.params.id) {
			// Setup the query		
			var query = 'SELECT * FROM Players WHERE PlayerFirstName = $1';
